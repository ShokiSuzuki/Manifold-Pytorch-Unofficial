...
def get_args_parser():
    ...
    parser.add_argument('--lambda-distill', default=1.0, type=float, help="")
    parser.add_argument('--lambda-patch', default=1.0, type=float, help="")
    parser.add_argument('--lambda-intra', default=4.0, type=float, help="")
    parser.add_argument('--lambda-inter', default=0.1, type=float, help="")
    parser.add_argument('--lambda-random', default=0.2, type=float, help="")
    parser.add_argument('--hidden-stages', default=[(0, 0), (1, 1), (2, 2), (9, 21), (10, 22), (11, 23)], type=int, nargs='+')
